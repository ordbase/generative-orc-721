...
Welcome.
The idea is to match-up all 133 .PNG inscriptions in
the recursive punks collection
with the "originals" in the CryptoPunksData contract (Anno 2021).




And if there's a pixel-perfect match
to deploy a new ordgen / ORC-721 collection - 10 000 D.I.Y. Genesis Punks!
